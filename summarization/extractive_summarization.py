...
if __name__ == '__main__':
    ...
    chapter = sorted(os.listdir('../example/book/sherlockholmes')[:-6],key=lambda x: int(re.compile('[0-9]+').findall(x)[0]))
    print(chapter)
    for i in chapter[:1]:
    ...
    # with open('../example/book/thelittleprince/summarization_max_sum2.json','w',encoding='UTF8') as f:
